...
extern NSString *const THEME_DEFAULTS;
extern NSString *const THEME_COLOR;
extern NSString *const THEME_FONTCOLOR;
extern NSString *const THEME_SIZE;
extern NSString *const THEME_FONT;
extern NSString *const THEME_NAVIGATIONBAR;
extern NSString *const THEME_TABBAR;
extern NSString *const THEME_TABBARSELECTED;
extern NSString *const THEME_LABEL_LEVEL1;
extern NSString *const THEME_LABEL_LEVEL2;
extern NSString *const THEME_LABEL_LEVEL3;
extern NSString *const THEME_LABEL_LEVEL4;
extern NSString *const THEME_LABEL_LEVEL5;
extern NSString *const THEME_LABEL_LEVEL6;
extern NSString *const THEME_RED;
extern NSString *const THEME_GREEN;
extern NSString *const THEME_BLUE;
...
static void HSL2RGB(float h, float s, float l, float* outR, float* outG, float* outB)
{
	...
	for(i = 0; i < 3; ++i) {
		...
		if(6.0 * temp[i] < 1.0)
			...
			if(2.0 * temp[i] < 1.0) temp[i] = temp2;
			else {
				if(3.0 * temp[i] < 2.0) temp[i] = temp1 + (temp2 - temp1) * ((2.0 / 3.0) - temp[i]) * 6.0;
				else temp[i] = temp1;
			}
		}
	}
