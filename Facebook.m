...
- (void) authorize:(NSString*)application_id
	...
	SettingsManager *setm = [[SettingsManager alloc] init];
	application_id = [NSString stringWithString: [setm facebookApiKey]];
	//application_id = [setm facebookApiKey];
	[setm release];
	
	NSLog(@"%@", application_id);
...
- (void)logout:(id<FBSessionDelegate>)delegate {
  ...
  _sessionDelegate = delegate;
	...
	[self requestWithMethodName:@"auth.expireSession" andParams:params andHttpMethod:@"GET" andDelegate:nil];
    [params release];
