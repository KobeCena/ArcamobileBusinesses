//
//  MyReviewsTableViewController.h
...
@interface MyReviewsTableViewController : UITableViewController {
    MyReviewsCell *tmpCell;
...
@property (nonatomic, retain) IBOutlet MyReviewsCell *tmpCell;
