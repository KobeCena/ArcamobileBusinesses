/*
	ARCAState.h
	The implementation of properties and methods for the ARCAState object.
	Generated by SudzC.com
*/
#import "ARCAState.h"

@implementation ARCAState
	@synthesize _id = __id;
	...
	+ (ARCAState*) newWithNode: (CXMLNode*) node
	{
		if(node == nil) { return nil; }
		return (ARCAState*)[[[ARCAState alloc] initWithNode: node] autorelease];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[ARCAState class]]) {
